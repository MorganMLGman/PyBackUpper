...
class Scheduler(BlockingScheduler):
    ...
    def __init__(
        self,
        backupper:BackupManager,
        trigger:CronTrigger,
        logger:logging.Logger=None) -> None:
        """Initialize the Scheduler class.

        Args:
            backupper (BackupManager): BackupManager instance.
            trigger (CronTrigger): CronTrigger instance.
        ...
        self.logger.info(
            f"Scheduler configured with cron: {self.trigger.fields} and timezone: {self.trigger.timezone}")
    ...
    def to_CronTrigger(
        ...
        Args:
            ...
            day_of_week (str, optional): Day of week. Defaults to "*".
            For example: "0,1,2,3,4,5,6" or "MON,TUE,WED,THU,FRI,SAT,SUN".
        ...
        if minute != "*":
            try:
                ...
                raise ValueError("Invalid minute") from e
        ...
        if hour != "*":
            try:
                ...
                raise ValueError("Invalid hour") from e
        ...
        if day_of_month != "*":
            try:
                ...
                raise ValueError("Invalid day of month") from e
        ...
        if month != "*":
            try:
                ...
                raise ValueError("Invalid month") from e
